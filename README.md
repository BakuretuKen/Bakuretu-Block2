...
| ファイル名                | 説明                       |
|---------------------------|----------------------------|
| bakuretublock207.js       | ゲーム本体 v2.07           |
...
[アニメーション利用ゲーム開始](https://bakuretuken.github.io/bakuretu-block2a/)

------------------------------------------------------------

## ゲームプログラムの改造

`index.html`で読み込んでいる JSプログラム `bakuretublock207.js`を改造してください

```
<script src="bakuretublock207.js"></script>
```
...
| 9 | 敗北。ゲームが敗北した状態 |
| 10 | 勝利。ゲームが勝利した状態 |
| 11 | ゲーム1再開待ち。ゲーム1でミスして再開待ちの状態 |
| 12 | ゲーム2再開待ち。ゲーム2でミスして再開待ちの状態 |
